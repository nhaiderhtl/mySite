      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4 p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">nico@example.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4 p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Montag - Freitag, 9:00 - 17:00</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Social Links */}
            <div>
              <h4 className="text-xl font-bold text-gray-900 mb-4">Folge mir</h4>
              <div className="flex space-x-4">
                <a
                  href="https://github.com/nhaiderhtl"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-gray-900 rounded-2xl flex items-center justify-center text-white hover:scale-110 transition-all duration-300 hover:shadow-lg"
                >
                ...
                <a
                  href="#"
                  className="w-12 h-12 bg-blue-600 rounded-2xl flex items-center justify-center text-white hover:scale-110 transition-all duration-300 hover:shadow-lg"
                >
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-2xl border border-gray-100">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">Schreib mir eine Nachricht</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isSubmitting ? (
                  <>
              ...
              {submitStatus === 'error' && (
                <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded-xl">
                  ❌ Es gab einen Fehler beim Senden. Versuche es bitte erneut.
                </div>
              )}
            </form>
          </div>
